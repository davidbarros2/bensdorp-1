...
**Wave 1** — Schema + test scaffolding

- [x] 07-01-PLAN.md — scan_exit_triggers schema extension + Wave 0 test stubs
...
- [x] 07-03-PLAN.md — scan.py Typer command (time gate, idempotency, --force) + all 10 tests implemented
...
- [x] 08-02-PLAN.md — buy.py full CMD-06 implementation + 5 test_buy.py scenarios filled in
- [x] 08-03-PLAN.md — sell.py full CMD-07 implementation + 3 test_sell.py scenarios filled in
- [x] 08-04-PLAN.md — fix.py full CMD-08 implementation + 3 test_fix.py scenarios filled in

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 08-05-PLAN.md — Full verification gate (pytest --cov >= 90%, mypy strict, ruff check, ruff format check)
